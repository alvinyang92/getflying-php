<div id="openOverlay" class="cursor-pointer mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-4 lg:gap-x-3 lg:px-8">
    <div class="cursor-pointer aspect-h-3 aspect-w-3 hidden overflow-hidden rounded-lg lg:block col-span-2">
        <!-- image 1 -->
        <img src="./assets/images/tour-gallery/safari-01.jpg" alt="Two each of gray, white, and black shirts laying flat." class="w-full object-cover object-center">
    </div>
    <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-4">
        <div class="cursor-pointer aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            ...
            <!-- image 2 -->
            <img src="./assets/images/tour-gallery/safari-02.jpg" alt="Model wearing plain black basic tee." class="w-full object-cover object-center">
        </div>
        <div class="cursor-pointer aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">

            <!-- image 3 -->
            <img src="./assets/images/tour-gallery/safari-03.jpg" alt="Model wearing plain black basic tee." class="w-full object-cover object-center">
        </div>
    </div>
    <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-4">
        <div class="cursor-pointer aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
            ...
            <!-- image 4 -->
            <img src="./assets/images/tour-gallery/safari-04.jpg" alt="Model wearing plain black basic tee." class="w-full object-cover object-center">
        </div>
        <div class="cursor-pointer aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">

            <!-- image 5 -->
            <img src="./assets/images/tour-gallery/safari-05.jpg" alt="Model wearing plain black basic tee." class="w-full object-cover object-center">
        </div>
    </div>
</div>
