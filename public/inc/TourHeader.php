...
$gridCardFull = '{
         ...
         "name": "13 days 10 nights discovery of South Africa",
...
<div class="mx-auto px-4 mt-28 max-w-2xl lg:max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="space-y-2 sm:space-y-0 flex flex-col sm:flex-row items-start md:items-center mt-3">
        <div class="flex gap-1">
            ...
            <!-- country -->
            <div class="px-0 sm:px-3 border-r-0 lg:border-r-[1px]">
        ...
        <div class="flex gap-1">
            <!-- logo -->
            <div class="flex items-center gap-2 px-0 sm:px-3 border-r-0 lg:border-r-[1px] h-[24px]">
                <!-- image -->
                <div class="w-7 h-7 ">
            ...
            <div class="px-0 sm:px-3">
                <p class="font-medium text-gray-500 dark:text-gray-400"><?php echo $items->tour_id; ?></p>
            </div>
        </div>
