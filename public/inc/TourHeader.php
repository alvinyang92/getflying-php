...
<div class="mx-auto mt-6 max-w-2xl lg:max-w-7xl sm:px-6 lg:px-8">
    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl"><?php echo $items->name; ?></h1>
    <div class="flex items-center mt-3">
        <!-- star -->
        <div class="flex space-x-2 pr-3 border-r-[1px]">
        ...
        <!-- country -->
        <div class="px-3 border-r-[1px]">
            <p class="font-medium text-gray-500 dark:text-gray-400"><?php echo $items->country; ?></p>
        </div>

        <!-- logo -->
        <div class=" flex items-center gap-2 px-3 border-r-[1px] h-[24px]">
            <!-- image -->
