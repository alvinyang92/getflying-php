...
// Decode JSON data
$items = json_decode($gridCardReview);
?>
...
<?php foreach ($items as $item) { ?>
    <div class="bg-gray-100/60 p-8 rounded-xl">
        ...
        <div class="flex items-center mb-2">
            ...
            <h3 class="ml-2 text-sm font-semibold text-gray-600 dark:text-white">4.9</h3>
        </div>
        <p class="mb-2 text-gray-500 dark:text-gray-400"><?php echo $item->review; ?></p>
    </div>
<?php } ?>