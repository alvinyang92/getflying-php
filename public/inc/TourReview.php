<div id="review" class="pb-10 ">
    <!-- title-->
    <div class="mt-10">
        <h2 class="text-2xl font-bold leading-10 tracking-tight text-gray-900">Customer Reviews</h2>
    </div>
    <!-- review data -->
    <div class="col-span-4">
        <div class="mt-3 flex items-center">
            ...
            <p class="ml-2 text-sm text-gray-900"><span class="font-semibold">4.9</span> Based on 1624 reviews</p>
        </div>
    ...
    <!-- customer review -->
    <div class="mt-16 lg:col-span-7 lg:col-start-6 ">
        <div class="flow-root">
            <div class="-my-12 divide-y divide-gray-200">
                ...
                <div class="py-12">
                    ...
                    <div class="mt-4 space-y-6 text-base italic text-gray-600">
                        <p>Our safari was absolutely incredible! The wildlife encounters were beyond words, and the whole experience left us in awe.</p>
                    </div>
                </div>
                <!-- item -->
                <div class="py-12">
