<nav class="bg-gray-100" aria-label="Progress">
  ...
  <div class=" mx-auto max-w-2xl py-20 px-3 ">
    <ol role=" list" class="w-full flex items-center">
      ...
      <li class="relative flex w-full">
        <!-- line -->
        <div class="absolute inset-0 flex justify-center top-4 z-10" aria-hidden="true">
          <div class="h-0.5 w-full bg-blue-800"></div>
        </div>
        <div class="flex flex-col gap-3">
          ...
          <!-- word -->
          <span class="text-sm w-full text-center">Details</span>
        </div>
      </li>
