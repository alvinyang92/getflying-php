...
<div class="bg-white px-6 py-28 lg:px-8">
  <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
    <p class="text-base leading-7 text-gray-700">20 Jan 2024</p>
    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Revolutionising the travel industry, one partnership at a time
</h1>
