    ...
    <div class="w-full h-screen flex items-center justify-center">
        ...
        <div class="w-full lg:w-1/2 xl:w-2/3 2xl:w-3/4  h-full bg-white flex items-center justify-center">
            <div class="w-full mx-auto max-w-3xl px-3 sm:p-20">
                ...
                <!-- title -->
                <h2 class="text-center text-3xl sm:text-5xl font-bold text-gray-800">Login</h2>
                <p class="text-center text-gray-800 mt-2 sm:mt-4">Welcome back.</p>
                    ...
                    <div class="col-span-2">
                        <div class="">
                          ...
                          >
                            ...
                            <p class="mt-6 text-black text-sm font-medium text-center">Don’t have an account?  <a class="underline text-gray-600" href="register.php">Join Getflying</a></p>
                        </div>
                    </div>
                </form>
