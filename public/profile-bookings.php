...
<div class="mx-auto max-w-7xl pt-5 lg:flex lg:gap-x-16 lg:px-8">
        ...
        <nav class="flex-none px-4 sm:px-6 lg:px-0">
            <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
                ...
                <li>
                    ...
                    <a href="profile-general.php" class="text-gray-700 hover:text-gf-light-blue hover:bg-gray-50 group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">
                ...
                <li>
                    ...
                    <a href="profile-bookings.php" class="bg-gray-50 text-gf-light-blue group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">

                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 shrink-0 text-gf-light-blue">
    ...
    <main class="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
        <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
            <div>
                <h2 class="text-base font-semibold leading-7 text-gray-900">Bookings</h2>
                <!-- <p class="mt-1 text-sm leading-6 text-gray-500">This information will be displayed publicly so be careful what you share.</p> -->

                <!-- item -->
                <div class="">
                    <div class="mt-6 flex w-full gap-x-4 border-t border-gray-900/5 py-6">
                        <!-- image -->
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            <dd class="mt-1 font-medium leading-6">Total Paid: RM435.60</dd>
                            <dd class="mt-1 font-medium leading-6 text-green-500">Booking Confirmed</dd>
                        </div>
                    </div>
                    <div class="mt-6 flex w-full gap-x-4 border-t border-gray-900/5 py-6">
                        <!-- image -->
