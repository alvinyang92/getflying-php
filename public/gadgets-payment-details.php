      ...
      <div class="mx-auto max-w-lg lg:max-w-none">
        ...
        <ul role="list" class="divide-y divide-gray-200 text-sm font-medium text-gray-900">
          <li class="flex items-start space-x-4 py-6">
            <img src="https://images.unsplash.com/photo-1696257203553-20ada15fce65?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3958&q=80" alt="Moss green canvas compact backpack with double top zipper, zipper front pouch, and matching carry handle and backpack straps." class="h-20 w-20 flex-none rounded-md object-cover object-center">
            <div class="flex-auto space-y-1">
              <h3>Red Bag</h3>
              <p class="text-gray-500">Moss</p>
              <p class="text-gray-500">5L</p>
            </div>
            <p class="flex-none text-base font-medium">RM70.00</p>
          </li>
        ...
        <dl class="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-900 lg:block">
          ...
          <div class="flex items-center justify-between border-t border-gray-200 pt-6">
            ...
            <dd class="text-base">RM361.80</dd>
          </div>
        </dl>
      ...
      <div class="mx-auto max-w-lg lg:max-w-none">
        ...
        <section aria-labelledby="billing-heading" class="mt-10">
          ...
          <div class="mt-6 flex items-center">
            <input id="same-as-shipping" name="same-as-shipping" type="checkbox" checked class="h-4 w-4 rounded border-gray-300 text-gf-dark-blue focus:ring-gf-dark-blue">
            <div class="ml-2">
        ...
        <div class="mt-10 border-t border-gray-200 pt-6 sm:flex sm:items-center sm:justify-between">
          <button type="submit" class="w-full rounded-md border border-transparent bg-gf-light-blue px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gf-light-blue focus:outline-none focus:ring-2 focus:ring-gf-light-blue focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last sm:ml-6 sm:w-auto">Continue</button>
